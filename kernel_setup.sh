...
clone_tc() {
	...
	git clone --depth=1 git clone https://github.com/sohamxda7/llvm-stable -b gcc64 $TC_DIR64
	git clone --depth=1 git clone https://github.com/sohamxda7/llvm-stable -b gcc32 $TC_DIR32
}
